          ...
          <aside className="w-64 bg-blue-900 text-white flex flex-col fixed h-full shadow-xl">
           ...
           {/* Links de Navegação */}
            <nav className="flex-1 p-4 space-y-1">
              <Link href="/" className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800/50 text-blue-100 hover:text-white font-medium transition">
              ...
              <Link href="/importadores" className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800/50 text-blue-100 hover:text-white font-medium transition">
                <svg className="w-5 h-5 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/certificados" className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800/50 text-blue-100 hover:text-white font-medium transition">
                <svg className="w-5 h-5 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/produtos" className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800/50 text-blue-100 hover:text-white font-medium transition">
              ...
              <Link href="/etiquetas" className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800/50 text-blue-100 hover:text-white font-medium transition">
                <svg className="w-5 h-5 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
